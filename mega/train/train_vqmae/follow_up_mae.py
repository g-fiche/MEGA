...
class Follow:
    ...
    def create_directory(self):
        ...
        self.path = path_time
        # shutil.copytree("configs/config_mae", path_time / "config_mae")
    ...
    def save_model(
        self, boolean: bool, parameters: dict, epoch: int, every_step: int = 10
    ):
    ...
    def __call__(
        ...
        self.save_model(
            boolean=self.find_best_model(loss_validation),
